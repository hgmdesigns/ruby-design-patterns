...
app = FXApp.new("CompositeGUI", "CompositeGUI")
main_window = FXMainWindow.new(app, "Composite", nil, nil, DECOR_ALL)
...
text_editors = FXHorizontalFrame.new(super_frame, LAYOUT_FILL_X|LAYOUT_FILL_Y)
